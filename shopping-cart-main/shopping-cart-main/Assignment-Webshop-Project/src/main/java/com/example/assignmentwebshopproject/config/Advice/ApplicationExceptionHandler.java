package com.example.assignmentwebshopproject.config.Advice;
...
import com.example.assignmentwebshopproject.config.exception.ProductNotFoundWithThatIDException;
