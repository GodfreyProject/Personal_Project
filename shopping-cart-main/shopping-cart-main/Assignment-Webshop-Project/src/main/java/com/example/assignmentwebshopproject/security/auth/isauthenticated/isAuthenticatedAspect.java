...
public class isAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.assignmentwebshopproject.security.auth.isauthenticated.isAuthenticated)")
    public void annotatedMethod(){

    }

    @Pointcut("@within(com.example.assignmentwebshopproject.security.auth.isauthenticated.isAuthenticated)")
