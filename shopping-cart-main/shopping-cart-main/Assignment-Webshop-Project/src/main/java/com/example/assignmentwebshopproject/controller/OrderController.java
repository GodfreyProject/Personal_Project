...
//        CreateOrderResponseDTO responseOrderDTO = new CreateOrderResponseDTO();
    ...
    public ResponseEntity<CreateOrderResponseDTO> GetDiscount(@RequestBody CreateOrderRequestDTO orderDTO) {
        // logger.info("Request Payload " + orderDTO.toString());
        CreateOrderResponseDTO responseOrderDTO = new CreateOrderResponseDTO();
        Double amount = getUserDiscountUseCase.getUserDiscount((orderDTO.getCartItems()));
